...
class PricesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create price" do
    assert_difference('Price.count') do
      post prices_url, params: { price: { flight_id: @price.flight_id, price: @price.price, seat_level: @price.seat_level } }
    end
  ...
  test "should update price" do
    patch price_url(@price), params: { price: { flight_id: @price.flight_id, price: @price.price, seat_level: @price.seat_level } }
